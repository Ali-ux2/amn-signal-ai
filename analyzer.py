...
def fetch_candles(yahoo_symbol, lookback="5d"):
...
def analyze_pair(display_pair):
    ...
    if len(close) >= 50 and not pd.isna(ema50.iloc[-1]):
        ...
        above50 = last_c > last_ema21
        below50 = last_c < last_ema21
    ...
    if votes_call < 2 and votes_put < 2:
        return None
